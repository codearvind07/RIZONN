...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    subItems: [
      { title: "Rizonn OS", href: "/products/software/Rizonn-os" },
      { title: "Rizonn Share", href: "/products/software/Rizonn-share" },
      { title: "Rizonn Whiteboard", href: "/products/software/Rizonn-whiteboard" },
      { title: "Rizonn EDU OS", href: "/products/software/Rizonn-edu-os" },
      { title: "Rizonn Class", href: "/products/software/Rizonn-class" },
      { title: "Rizonn EasiClass", href: "/products/software/Rizonn-easiclass" },
      { title: "Rizonn Connect", href: "/products/software/Rizonn-connect" },
      { title: "Rizonn Pivot", href: "/products/software/Rizonn-pivot" },
    ],
  },
];